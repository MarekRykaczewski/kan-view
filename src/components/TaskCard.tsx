...
function TaskCard({ task, deleteTask, updateTask }: Props) {
  ...
  if (editMode) {
    return (
      <div className="bg-shadeOne p-2.5 h-[100px] min-h-[100px] items-center flex text-left rounded-xl hover:ring-2 hover:ring-inset hover:ring-accentMain cursor-grab relative task">
        <textarea
          value={task.content}
          autoFocus
